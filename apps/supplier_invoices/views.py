...
from .services import approve_supplier_invoice, create_invoice_line, create_supplier_invoice, lock_supplier_invoice
...
class SupplierInvoiceViewSet(viewsets.ModelViewSet):
    queryset = SupplierInvoice.objects.select_related("supplier", "created_by", "approved_by").all()
